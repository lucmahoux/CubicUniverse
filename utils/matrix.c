...
cubMat4 cub_utils_mat4_rotate(cubMat4 matrix, float angle,
    ...
    cubMat4 rot_m = cub_utils_mat4(1.0f);
...
cubMat4 cub_utils_mat4_perspective(float fov, float aspect_ratio,
    ...
    cubMat4 result = cub_utils_mat4(1.0f);
...
cubMat4 cub_utils_mat4_view_matrix(cubVec3 position, cubVec3 target,
                                    cubVec3 up) {
    cubMat4 view = cub_utils_mat4(1.0f);
    cubVec3 direction = CUB_VEC3_NORM(CUB_VEC3_SUB(position, target));
    cubVec3 right = CUB_VEC3_NORM(CUB_VEC3_CROSS(up, direction));
    ...
    cubMat4 cam_position = CUB_MAT4_TRANS( CUB_MAT4(1.0f),
